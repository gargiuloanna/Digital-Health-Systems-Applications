...
public class ServiceRequestResource extends BaseResource {
	...
	/*
	 * Each Service Request must have: a status an intent code indicating whether
	 * the request is a proposal, plan, or order. a code defining what is being
	 * requested a patient Each Service Request must support: a category when
	 * requested service should happen when request was made the requester
	 */
